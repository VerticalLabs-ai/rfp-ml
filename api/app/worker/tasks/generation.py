...
@shared_task(bind=True, name="api.app.worker.tasks.generation.generate_proposal_section")
def generate_proposal_section(
    ...
    logger.info(f"Starting section generation - Job: {job_id}, RFP: {rfp_id}, Section: {section_type}")
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            self.update_state(state="PROGRESS", meta={"progress": 10, "status": "loaded_rfp"})
            ...
            self.update_state(state="PROGRESS", meta={"progress": 20, "status": "loaded_profile"})
...
def generate_full_bid(
    ...
    logger.info(f"Starting full bid generation - Job: {job_id}, RFP: {rfp_id}, Mode: {generation_mode}")
    ...
    try:
        ...
        with SessionLocal() as db:
            ...
            self.update_state(state="PROGRESS", meta={"progress": 20, "status": "generating"})
